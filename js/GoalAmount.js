const amGoalForm = document.querySelector('.am--goalForm');
const amGoalInp = document.querySelector('.am--goalInp');
const amGoalBtn = document.querySelector('.am--goalBtn');
const amGoalBox = document.querySelector('.am--goalBox');
const amGoalTxt = document.querySelector('.am--goalTxt');

const amTotalWrap = document.querySelector('.am--totalWrap');
